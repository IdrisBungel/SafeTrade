      ...
      <Container>
        <Row>
          <Col md={12}>
            <h2 className="about-title">About SafeTrade</h2>
            <p className="about-text">
              <strong>SafeTrade</strong> is a trusted platform dedicated to ensuring secure online transactions. Our mission is to create a safe, transparent environment where users can trade with confidence.
            </p>
            <p className="about-text">
              By verifying sellers and securing payments, SafeTrade takes the worry out of online trading. Whether you’re buying or selling, our platform guarantees a seamless and protected experience every step of the way.
            </p>
          </Col>
        </Row>
      </Container>
